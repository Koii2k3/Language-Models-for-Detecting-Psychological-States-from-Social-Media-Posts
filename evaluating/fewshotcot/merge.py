...
if __name__ == '__main__':
    ...
    from_file1_path = os.path.join('evaluating', f'fscot_{column_to_extract}', f'{dataset_name}.csv')
    to_file2_path = os.path.join('evaluating', 'fewshotcot', f'{dataset_name}.csv')
