...
if __name__ == '__main__':
    ...
    from_file1_path = os.path.join('evaluating', f'zscotrs_{column_to_extract}', f'{dataset_name}.csv')
    to_file2_path = os.path.join('evaluating', 'zerocot_reason', f'{dataset_name}.csv')
